...
//                System.out.println("http 요청 데이터 : " + xml);
     ...
     * @auther 박성훈
     */
    public String drp_get(String token, String URL, String primary_key, String survey, String seq) {
        //get 부분 구현
        //http 요청시 test_XmlApiPost 객체에서 셋팅된 URL 주소와 파라미터 데이터를 결합하기 위한 변수
        String totalUrl = "";
        URL = URL + "/" + primary_key + "/" + survey + "/" + seq;
        totalUrl = URL.trim().toString();
     ...
     * @auther 박성훈
     */
    public String xml_drp_get(String token, String URL, String primary_key, String survey, String seq) {
        //get 부분 구현
        //http 요청시 test_XmlApiPost 객체에서 셋팅된 URL 주소와 파라미터 데이터를 결합하기 위한 변수
        String totalUrl = "";
        URL = URL + "/" + primary_key + "/" + survey + "/" + seq;
